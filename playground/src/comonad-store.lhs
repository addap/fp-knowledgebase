...
Store s a is literally a store/warehouse of a's accessed by s's with a read-head positioned at a particular s. The function s -> a is the lookup and the value s is the read head. If s ~ Int this seems isomorphic to Tape form the Comonad talk.
